...
public class BinaryUF {
    ...
    static void run() {
        ...
        UF uf = constructUF(vertices, rows, cols);
        for(int i = 0; i < problems; i++) {
           ...
           if(start == end) {
               if(startBinary)
                   ...
                   continue; // Was return before - was?
               }
           } else {
               res = uf.connected(start, end);
           }
    ...
    static UF constructUF(int[][] vertices, int rows, int cols) {
